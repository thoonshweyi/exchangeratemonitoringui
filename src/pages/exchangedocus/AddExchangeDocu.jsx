                            ...
                            <div className="rate-card">
                                <div className="rate-card-header">
                                    <div className="currency-info">
                                        ...
                                        <div>
                                            <div className="currency-name">USD - US Dollar</div>
                                            ...
                                            <div className="d-flex gap-4">
                                                <div className="mb-1">
                                                    ...
                                                    <input type="number" step="0.0001" className="form-control rate-input" 
                                                        name="tt_buy_${currencyCounter}" placeholder="0.0000" />
                                                </div>
                                                <div className="mb-1">
                                                    <label className="rate-label">Sell</label>
                                                    <input type="number" step="0.0001" className="form-control rate-input" 
                                                        name="tt_sell_${currencyCounter}" placeholder="0.0000" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-4 mb-3">
                                            ...
                                            <div className="d-flex gap-4">
                                                <div className="mb-1">
                                                    <label className="rate-label">Buy</label>
                                                    <input type="number" step="0.0001" className="form-control rate-input" 
                                                        name="cash_buy_${currencyCounter}" placeholder="0.0000" />
                                                </div>
                                                <div className="mb-1">
                                                    <label className="rate-label">Sell</label>
                                                    <input type="number" step="0.0001" className="form-control rate-input" 
                                                        name="cash_sell_${currencyCounter}" placeholder="0.0000" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-4 mb-3">
                                            ...
                                            <div className="d-flex gap-4">
                                                <div className="mb-1">
                                                    <label className="rate-label">Buy</label>
                                                    <input type="number" step="0.0001" className="form-control rate-input" 
                                                        name="earn_buy_${currencyCounter}" placeholder="0.0000" />
                                                </div>
                                                <div className="mb-1">
                                                    <label className="rate-label">Sell</label>
                                                    <input type="number" step="0.0001" className="form-control rate-input" 
                                                        name="earn_sell_${currencyCounter}" placeholder="0.0000" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
